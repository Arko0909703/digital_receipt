...
@Data
@Entity
@Table(name = "license_master_new")
public class LicenseMasterV2 {
	...
	@Column(name = "system_key", columnDefinition = "VARCHAR(50)")
	private String systemKey;
	
	@Column(name = "registration_no", columnDefinition = "VARCHAR(25)")
	private String registrationNo;
	
	@Column(name = "registration_code", columnDefinition = "VARCHAR(30)")
